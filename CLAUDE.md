...
- Use `nextjs-app-router-ui` for frontend development
- Use `neon-postgres-manager` for database design and operations
- Use `fastapi-backend-expert` for FastAPI development
...
## Active Technologies
- Python 3.11 (Backend/FastAPI), JavaScript/TypeScript (Frontend/Next.js 16+) + Next.js 16+ (App Router), FastAPI, SQLModel, Better Auth, Neon Serverless PostgreSQL (001-todo-web-app)
